...
/**
 * Created by linlinyeyu on 2017/12/21.
 */
public class GeoHash {
    ...
    public List<String> getGeoHashBase32For9() {
        double leftLat = this.lat - minLat;
        double rightLat = this.lat + minLat;
        double upLng = this.lng - minLng;
        double downLng = this.lng + minLng;
        ...
        String leftMid = getGeoHashBase32(leftLat, this.lng);
        ...
        //中间从上到下 3个
        String midUp = getGeoHashBase32(this.lat, upLng);
        if (!(midUp == null || "".equals(midUp))) {
            base32For9.add(midUp);
        }
        String midMid = getGeoHashBase32(this.lat, this.lng);
        if (!(midMid == null || "".equals(midMid))) {
            base32For9.add(midMid);
        }
        String midDown = getGeoHashBase32(this.lat, downLng);
        ...
        String rightMid = getGeoHashBase32(rightLat, this.lng);
    ...
    public String getGeoHashBase32() {
        return getGeoHashBase32(this.lat, this.lng);
    }
